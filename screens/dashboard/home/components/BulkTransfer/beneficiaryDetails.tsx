...
const BeneficiaryDetailsComponent = ({goBack,formData,onDelete,onEdit}:BeneficiaryDetailsComponentProps) => {
...
return <View style={{backgroundColor:"rgba(242, 242, 242, 1)",flexDirection:"column",padding:30,height:DEVICE.height,borderTopRightRadius:20,borderTopLeftRadius:20}}>
<Text style={{fontSize:14,marginBottom:30,color:"rgba(123, 127, 153, 1)",textAlign:"center",width:"90%",alignSelf:"center"}}>Salary Structure Overview</Text>

<MockInput 
 label="Account"
 component={<View style={{flexDirection:"row",alignItems:"center",gap:10}}>
 <Text>₦{ReturnComma(String(formData.amount))}</Text>
</View>}
 value={""}
 />
...
/>
<BaseButton 
style={{marginTop:20,borderColor:"white",backgroundColor:"white"}}
type="outline-purple"
onPress={onDelete}
